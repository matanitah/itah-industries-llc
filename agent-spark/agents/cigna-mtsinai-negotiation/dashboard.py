...
browse the leverage leaderboard, drill into a code's supporting facts, and
review flags raised by the health check. There is exactly one shared
...
tab_report, tab_codes, tab_flags, tab_log = st.tabs(
    ["📊 Leverage Report", "🔍 Code Detail", "🚩 Review Flags", "📜 Live Log"]
)
